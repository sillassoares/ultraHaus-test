    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="form_contact" method="POST" action="{{ url('/contact/' . $contact->id) }}">
                    <input type="hidden" name="_method" value="PUT" data-id="{{ $contact->id }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" name="name" placeholder="{{ trans('contact.form_name') }}" value="{{ $contact->name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="email" name="email" placeholder="{{ trans('contact.form_email') }}" value="{{ $contact->email }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control phone" id="phone" name="phone" placeholder="{{ trans('contact.form_phone') }}" value="{{ $contact->phone }}" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control cpf" id="cpf" name="cpf" placeholder="{{ trans('contact.form_cpf') }}" value="{{ $contact->cpf }}">
                        </div>
                    </div>
